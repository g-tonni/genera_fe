...
function NavbarMobile({ light }) {
  ...
  return (
    <>
      <div
        className={`w-full h-full z-10 bg-black ${panel === 'menu' ? ' flex' : ' hidden'}`}
      >
      ...
      <div className="fixed bottom-0 z-10 w-full h-20 mx-auto px-12 md:px-20 xl:px-25 py-6 bg-black flex lg:hidden justify-between items-center ">
        ...
        <div
          className="h-full w-5 text-gray-50/60  hover:text-gray-50 transition-colors duration-150 cursor-pointer"
          onClick={() => {
            setPanel('menu')
          }}
        >
